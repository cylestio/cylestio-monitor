...
try:
    ...
    from cylestio_monitor.patchers.openai_patcher import OpenAIPatcher, patch_openai_module, unpatch_openai_module
...
class MockPatcherModules:
    ...
    def setup():
        ...
        if "cylestio_monitor.patchers.openai_patcher.TraceContext" not in sys.modules:
            ...
            sys.modules["cylestio_monitor.patchers.openai_patcher.TraceContext"] = mock_trace_context
