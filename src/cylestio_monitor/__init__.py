...
from cylestio_monitor.monitor import get_api_endpoint, start_monitoring, stop_monitoring

# Apply patchers automatically on import
# This ensures all supported frameworks are automatically patched
from cylestio_monitor.patchers import (
...
from cylestio_monitor.utils.instrumentation import Span, instrument_function, instrument_method
