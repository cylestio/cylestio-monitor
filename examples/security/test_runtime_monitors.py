...
print(f"🔍 Monitoring started. Logs will be written to {log_file}")
print(f"🔌 Using telemetry endpoint: {custom_telemetry}")
...
print("\n🔍 Testing network connection monitoring...")
try:
...
try:
    ...
    try:
        ...
        print("  ✓ Connection failed (expected for test endpoint)")
    finally:
        s.close()
except Exception as e:
